...
let arr2 = new Array(1, 6, 5, 3, 3);
let arr3 = Array.of("anas", "basit", "hadi");
console.log(arr1);
console.log(arr2);
console.log(arr3);
...
let techCompanies = ["microsoft", "oracle", "google", "appple", "openai", "nvidia"];
// foreach
...
let numToFilter = [3, 7, 3, 6, 5];
let even = numToFilter.filter((item) => item % 2 === 0);
console.log(even);
